...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* Top nav */}
      <header className="sticky top-0 z-20 border-b border-cyan-500/10 bg-slate-950/90 backdrop-blur-xl">
        <div className="container-main flex h-20 items-center justify-between">
          <div className="text-lg font-bold tracking-[0.2em] uppercase text-cyan-300">
            Zuhair&nbsp;Khan
          </div>
          <nav className="hidden gap-8 text-base text-slate-300/90 sm:flex">
      ...
      <section className="section pt-24 pb-16">
        <div className="container-main grid gap-20 lg:grid-cols-2 items-center">
          ...
          <div className="order-2 lg:order-1 lg:pl-0">
            ...
            <div className="text-xl sm:text-2xl lg:text-3xl text-slate-300 mb-6 min-h-10">
              And I&apos;m a <TypewriterText />
            </div>
            <p className="text-base sm:text-lg text-slate-400 mb-6 max-w-xl leading-relaxed">
            ...
            <div className="mb-6 flex flex-wrap gap-2">
              <span className="chip text-xs px-3 py-1.5">Hybrid PQC × QKD</span>
              <span className="chip text-xs px-3 py-1.5">Quantum Machine Learning</span>
              <span className="chip text-xs px-3 py-1.5">Photonic Computing</span>
              <span className="chip text-xs px-3 py-1.5">Full-Stack Development</span>
            </div>
      ...
      <section className="section bg-slate-900/30 py-16">
        <div className="container-main">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="card p-6 text-center hover:border-cyan-400/30 transition-all">
              <p className="text-3xl font-bold text-cyan-400 mb-2">🏆</p>
              <p className="text-base font-semibold text-slate-200 mb-1">UTSC CMS Symposium Winner</p>
              <p className="text-sm text-slate-400">(Quantum Security)</p>
            </div>
            <div className="card p-6 text-center hover:border-cyan-400/30 transition-all">
              <p className="text-3xl font-bold text-cyan-400 mb-2">⚛️</p>
              <p className="text-base font-semibold text-slate-200 mb-1">PennyLane Certified</p>
              <p className="text-sm text-slate-400">(100% Completed)</p>
            </div>
            <div className="card p-6 text-center hover:border-cyan-400/30 transition-all">
              <p className="text-3xl font-bold text-cyan-400 mb-2">🔐</p>
              <p className="text-base font-semibold text-slate-200 mb-1">15+ Cybersecurity CTF</p>
              <p className="text-sm text-slate-400">Challenges Solved</p>
            </div>
            <div className="card p-6 text-center hover:border-cyan-400/30 transition-all">
              <p className="text-3xl font-bold text-cyan-400 mb-2">🚀</p>
              <p className="text-base font-semibold text-slate-200 mb-1">Next: Xanadu Residency</p>
              <p className="text-sm text-slate-400">& Cybersecurity Internship</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Experience pillars */}
      <section id="experience" className="section pt-20">
        <div className="container-main">
          <p className="section-label mb-3 text-sm">Experience</p>
          <h2 className="text-4xl sm:text-5xl font-bold mb-4">Domains I'm Actively Building In</h2>
      ...
      <section id="projects" className="section pt-20">
        <div className="container-main">
          <p className="section-label mb-3 text-sm">Selected Work</p>
          <h2 className="text-4xl sm:text-5xl font-bold mb-12">Projects & Research</h2>
      ...
      <section id="skills" className="section pt-20">
        <div className="container-main">
          <p className="section-label mb-3 text-sm">Skills</p>
          <h2 className="text-4xl sm:text-5xl font-bold mb-12">Tools I reach for most often.</h2>
