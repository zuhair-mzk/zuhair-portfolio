...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      {/* Hero */}
      <section className="section pt-12 sm:pt-20 pb-8 sm:pb-16">
        <div className="container-main grid gap-10 sm:gap-16 lg:gap-20 lg:grid-cols-2 items-center">
          ...
          <div className="order-2 lg:order-1 lg:pl-0">
            ...
            <div className="text-lg sm:text-2xl lg:text-3xl text-slate-300 mb-4 sm:mb-6 min-h-8 sm:min-h-10">
              And I&apos;m a <TypewriterText />
            </div>
            <p className="text-sm sm:text-base lg:text-lg text-slate-400 mb-4 sm:mb-6 max-w-xl leading-relaxed">
            ...
            <div className="mb-4 sm:mb-6 flex flex-wrap gap-2">
              <span className="chip text-xs px-2.5 sm:px-3 py-1 sm:py-1.5">PQC × QKD</span>
              <span className="chip text-xs px-2.5 sm:px-3 py-1 sm:py-1.5">Quantum ML</span>
              <span className="chip text-xs px-2.5 sm:px-3 py-1 sm:py-1.5 hidden sm:inline-flex">Photonic Computing</span>
              <span className="chip text-xs px-2.5 sm:px-3 py-1 sm:py-1.5">Full-Stack Dev</span>
            </div>

            <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-6">
              <Link
                href="#projects"
                className="inline-flex items-center rounded-full bg-linear-to-r from-cyan-400 to-emerald-400 px-5 sm:px-6 py-2.5 sm:py-3 text-xs sm:text-sm font-semibold text-slate-950 shadow-[0_0_25px_rgba(34,211,238,0.7)] hover:brightness-110 transition-all"
              >
                View Projects →
              </Link>
              <Link
                href={cvLink}
                className="inline-flex items-center rounded-full border-2 border-cyan-500/50 bg-slate-950/50 px-4 sm:px-5 py-2.5 sm:py-3 text-xs sm:text-sm font-semibold text-cyan-100 hover:border-cyan-300 transition-all"
              >
                Download CV
              </Link>
            </div>
            ...
            <div className="flex gap-3 sm:gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-slate-600/70 flex items-center justify-center hover:border-cyan-400 hover:bg-cyan-400/10 transition-all hover:scale-110"
                aria-label="GitHub"
              >
