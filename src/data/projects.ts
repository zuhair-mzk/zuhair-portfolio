// Project, research, and community entries.
// Migrated verbatim from ProjectsTabs.tsx — content changes (recategorisation to
// Security / Software / Quantum / Community, PhotonQML removal, CTF count) land in a later commit.

export type ProjectCategory = "Quantum Computing" | "Cybersecurity & Networking" | "Software Engineering" | "Leadership & Community";
...
export const projectsData: Record<ProjectCategory, Project[]> = {
  "Quantum Computing": [
    {
  ...
  "Cybersecurity & Networking": [
    {
      title: "Production Software Router & Network Protocol Engineering",
      body: "Built a production-quality software router (2000+ LOC in C) implementing IPv4 forwarding, ARP cache, and ICMP protocols with 100% test pass rate. Completed comprehensive network engineering labs covering SDN, traffic analysis, and protocol implementation.",
